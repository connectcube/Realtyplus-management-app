   ...
   return (
      <div className="flex flex-col bg-gray-50 h-full min-h-screen">
         ...
         <main className="flex-1 mx-auto p-4 md:p-6 container">
               ...
               <Card className="bg-white">
                  <CardContent className="flex justify-between items-center p-4">
                     <div>
                        ...
                        <p className="font-bold text-2xl">{user.notifications.messages.length}</p>
                     </div>
            ...
            {/* Main Dashboard Tabs */}
            <Tabs value={activeTab} onValueChange={setActiveTab} className="bg-white shadow rounded-lg h-fit">
